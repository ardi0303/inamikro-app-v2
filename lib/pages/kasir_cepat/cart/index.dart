...
import 'package:inamikro_app_v2/pages/kasir_cepat/cart/keranjang.dart';
...
class KasirCepatCart extends StatelessWidget {
  const KasirCepatCart({super.key});
        ...
        child: SizedBox(
          ...
          child: TextButton(
            onPressed: () {
              ...
              Navigator.pushNamed(context, '/kasir-cepat/nota');
              context.read<KasirCepatProvider>().updateDateTime();
            },
